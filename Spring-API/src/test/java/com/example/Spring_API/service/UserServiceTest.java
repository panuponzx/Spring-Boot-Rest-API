...
public class UserServiceTest {
    ...
    public void testCreateUserSuccess() {
        User newUser = new User(12,"Neymar",31,"neymar@gmail.com");
    ...
    public void testCreateUserAlreadyExists(){
        User existingUser = new User(1,"Messi",32,"messi@gamil.com");
        assertThrows(IllegalArgumentException.class, () -> userService.createUser(existingUser));
    }

    @Test
    public void testUpdateUserSuccess() {
        User updateuser = new User(1,"Messi",35,"messi32@gmail.com");
