...
public class UserControllerTest {
    ...
    public void testGetUser() throws Exception {
        ...
        User user = new User(1, "Messi", 31, "messi@gmail.com");
    ...
    public void testCreateUser() throws Exception {
        // ข้อมูลผู้ใช้ที่ต้องการสร้าง
        User newUser = new User(10, "Neymar", 29, "neymar@gmail.com");
    ...
    public void testUpdateUser() throws Exception{
        ...
        User updateUser = new User(1,"Messi",32,"messi@gmail.com");
    ...
    public void testDeleteUser() throws Exception{
        ...
        User deleteUser = new User(1,"Messi",32,"messi@gmail.com");
